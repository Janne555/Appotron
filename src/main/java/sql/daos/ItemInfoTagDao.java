 ...
 * @author Janne
 */
public class ItemInfoTagDao {
    private Database db;

    public ItemInfoTagDao(Database db) {
        this.db = db;
    }

    public Tag store(Tag t) throws SQLException {
        db.update("INSERT INTO ItemInfoTag(iteminfo_id, key, value) VALUES(?,?,?)", false, t.getItemId(), t.getKey(), t.getValue());
        return t;
    }
